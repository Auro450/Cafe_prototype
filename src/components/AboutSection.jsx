  ...
  return (
    <section className="about-section">
      <div className="custom-promo-banner">
        ...
        <img src="/products/product_chicken_burger.png" className="promo-img promo-burger" alt="Burger" />
        <img src="/products/product_veg_sandwich.png" className="promo-img promo-sandwich" alt="Sandwich" />
